...
var author$project$Dalmatian$Editor$Applicative$reset = {album: _List_Nil, languages: _List_Nil, panelValues: _List_Nil, selector: author$project$Dalmatian$Editor$Selecting$UnknownSelector, tokenValue: elm$core$Maybe$Nothing};
					...
					[
						...
						_List_fromArray(
							[
								...
								(model.greeting === 'You say \"goodbye\"') ? author$project$Main$Hello : author$project$Main$Goodbye)
							]),
						_List_fromArray(
							[
